...
public class SolarSystem {
    ...
    public SolarSystem(CanvasWindow canvas) {
        ...
        mercury = new Planet(EARTH_SIZE * 0.5, EARTH_RADIUS * 0.5,
            EARTH_SPEED * 0.6, "planets/mercury.png");
        venus = new Planet(EARTH_SIZE * 0.8, EARTH_RADIUS * 0.75,
            EARTH_SPEED * 0.75, "planets/venus.png");
        earth = new Earth(EARTH_SIZE, EARTH_RADIUS, EARTH_SPEED, "planets/earth.png");
        mars = new Planet(EARTH_SIZE * 0.7, EARTH_RADIUS * 1.25, EARTH_SPEED * 0.5,
            "planets/mars1.png");
        jupiter = new Planet(EARTH_SIZE * 2.5, EARTH_RADIUS * 1.5,
            EARTH_SPEED * 0.4, "planets/jupiter.png");
        saturn = new Planet(EARTH_SIZE * 2.2, EARTH_RADIUS * 1.75,
            EARTH_SPEED * 0.3, "planets/saturn.png");
        uranus = new Planet(EARTH_SIZE * 1.5, EARTH_RADIUS * 2, EARTH_SPEED * 0.2,
            "planets/uranus.png");
        neptune = new Planet(EARTH_SIZE * 1.3, EARTH_RADIUS * 2.25,
            EARTH_SPEED * 0.1, "planets/neptune.png");
